            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  <tr>
                    <td scope="col">1</td>
                    <td scope="col">Februari 2021</td>
                    <td scope="col">
                      <a href="<?= base_url('assets/laporan/perubahanmodal.pdf') ?>">
                        <button type="submit" class="btn btn-success mr-3">Cetak Laporan Perubahan Modal</button></a>
                    </td>
                  </tr>
                </tbody>
              </table>
